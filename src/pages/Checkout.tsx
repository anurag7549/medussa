...
export default function Checkout() {
  ...
  const { items, subtotal, tax, total, totalItems } = useCart();
  const { user } = useAuth();
    ...
    return (
      <div className="section-container animate-fade-in py-16">
        <div className="mx-auto max-w-md text-center">
          ...
          <h1 className="mb-2 font-display text-2xl font-semibold">Sign in to checkout</h1>
    ...
    return (
      <div className="section-container animate-fade-in py-16">
        <div className="mx-auto max-w-md text-center">
          ...
          <h1 className="mb-2 font-display text-2xl font-semibold">Thank you for your order!</h1>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <form id="checkout-form" onSubmit={handleSubmit} className="space-y-8">
              ...
              <button type="submit" disabled={isSubmitting} className="btn-accent w-full lg:hidden">
